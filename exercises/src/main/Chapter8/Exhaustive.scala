package main.Chapter8.exhaustive
...
import main.Chapter6.{RNG, State}
import main.Chapter7.Par.Par
import main.Chapter7._
import main.Chapter8.exhaustive.Gen._
import main.Chapter8.exhaustive.Prop._
import main.Chapter8.exhaustive.Status._
...
object Gen {
  ...
  */
  def cartesian[A](s: Stream[Stream[A]]): Stream[Stream[A]] =
    s.foldRight(Stream(Stream[A]()))((hs,ts) => map2Stream(hs,ts)((h, tl) => Stream.cons(h, tl)))
